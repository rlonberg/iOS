...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func initializeReachability(_ application: UIApplication) {
        
        NotificationCenter.default.addObserver(forName: NSNotification.Name.reachabilityChanged, object: nil, queue: nil) {
            note in
